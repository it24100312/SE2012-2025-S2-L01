...
public class Grades {
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            System.out.println("7. Display the student grades table");
            ...
            switch (choice) {
                ...
                case 7:
                    ...
                    for (int i = 0; i < n; i++) {
                        ...
                        for (int j = 0; j < 3; j++) {
                            if (studentMarks[i][j] >= 90) {
                                studentGrades[i][j] = "Grade A";
                            }
                            else if (studentMarks[i][j] >= 80) {
                                studentGrades[i][j] = "Grade B";
                            }
                            else if (studentMarks[i][j] >= 70) {
                                studentGrades[i][j] = "Grade C";
                            }
                            else if (studentMarks[i][j] >= 60) {
                                studentGrades[i][j] = "Grade D";
                            }
                            else {
                                studentGrades[i][j] = "Fail";
                            }
                        }
                        System.out.printf("    %-6d |   %-7s   |  %-7s  | %-4s\n", i + 1, studentGrades[i][0], studentGrades[i][1], studentGrades[i][2]);
                    }
                    break;
